...
- Phase 15 pre-smoke 新基线已写入 `F:\Linghun\docs\audit\phase-15-pre-smoke-full-reference-parity-and-architecture-runtime-audit.md`，Batch B source-of-truth / implementation design 已写入 `F:\Linghun\docs\audit\phase-15-pre-smoke-batch-b-architecture-runtime-source-of-truth.md`：进入真实项目 smoke 前必须先完成 Batch C 并重新验收；这属于 Phase 15 pre-smoke 收口，不是 Phase 15.5 / 16+。
