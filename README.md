...
- **2026-07-12（当下完美版）**：7 月 8/9 日后的主链整体收口，覆盖长任务 compact/cache、Provider 与流恢复、请求中断、agent/workflow/verification、MCP/Web/memory、终端可见层和反幻觉证据链；预检引擎只开放 TypeScript/TSX、Python、Rust、Go、Java 五条成熟链路，并随 Windows 包携带固定兼容版 TypeScript/Pyright。详见：[更新记录](./docs/updates.md#2026-07-12-主链与产品级预检整体收口)。
