...
async function copyPreEngine(source, platformArch) {
  ...
  if (await readable(shellHelperSource)) {
    await copyFile(shellHelperSource, join(cliTargetDir, "shell-deep-layer.cjs"));
  }
  if (await readable(csharpHelperSource)) {
    await copyFile(csharpHelperSource, join(cliTargetDir, "csharp-deep-layer.cjs"));
  }
  ...
  if (await readable(kotlinHelperSource)) {
    await copyFile(kotlinHelperSource, join(cliTargetDir, "kotlin-deep-layer.cjs"));
  }
  if (await readable(dartHelperSource)) {
    await copyFile(dartHelperSource, join(cliTargetDir, "dart-deep-layer.cjs"));
  }
  ...
  if (await readable(shellHelperSource)) {
    await copyFile(shellHelperSource, join(pkgTargetDir, "shell-deep-layer.cjs"));
  }
  if (await readable(csharpHelperSource)) {
    await copyFile(csharpHelperSource, join(pkgTargetDir, "csharp-deep-layer.cjs"));
  }
  if (await readable(phpHelperSource)) {
  ...
  if (await readable(kotlinHelperSource)) {
    await copyFile(kotlinHelperSource, join(pkgTargetDir, "kotlin-deep-layer.cjs"));
  }
  if (await readable(dartHelperSource)) {
    await copyFile(dartHelperSource, join(pkgTargetDir, "dart-deep-layer.cjs"));
  }
  if (await readable(swiftHelperSource)) {
