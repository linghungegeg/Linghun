...
describe("Phase E request lifecycle provider failure coverage", () => {
  const cases: Array<[unknown, ReturnType<typeof classifyProviderFailure>]> = [
    ...
    [{ code: "PROVIDER_NON_SSE_STREAM", message: "html response" }, "compatibility"],
    [{ code: "PROVIDER_MALFORMED_STREAM", message: "bad sse" }, "stream_parse"],
    [{ code: "PROVIDER_PARTIAL_TOOL_CALL", message: "unfinished tool call" }, "tool_stream"],
