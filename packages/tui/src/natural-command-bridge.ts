...
const COMMAND_CAPABILITY_DATA: CommandCapability[] = [
  ...
  cap(
    ...
    "上下文压缩",
    "Compact",
    "执行受控 Compact Lite：只记录边界和裁剪本地上下文，不执行工具、不写文件、不写长期记忆。",
    "Runs controlled Compact Lite: records boundaries and trims local context only; no tools, file writes, or long-term memory writes.",
    "需要手动压缩上下文或查看 compact 边界。",
    "Use for manual context compaction or compact boundary status.",
    "readonly",
  ),
  cap(
    "break-cache",
