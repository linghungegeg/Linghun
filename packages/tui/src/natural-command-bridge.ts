...
const COMMAND_CAPABILITY_DATA: CommandCapability[] = [
  ...
  cap(
    ...
    "Runs controlled Context Compact: provider preflight can inject a redacted summary and boundary; no tools, project file writes, or long-term memory writes.",
    "需要压缩长对话或清理上下文时使用。查看状态请用 /compact status 或 /context。",
    "Use to compact long conversations or clean up context. Use /compact status or /context for status.",
    "start_gate",
  ),
  cap(
    "context",
    ...
    "Shows context pressure, compact summary, pairing safety, and compact boundaries without running compact.",
    "需要查看上下文压力、压缩摘要、pairing 安全或 compact 边界状态。",
