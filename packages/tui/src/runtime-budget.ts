...
export const LINGHUN_PROVIDER_TOOL_RESULT_CHARS = 16_000;
...
export const LINGHUN_TOOL_RESULT_PRESSURE_RATIO = 0.6;
export const LINGHUN_TOOL_RESULT_RECENT_RAW_RESULTS = 6;
