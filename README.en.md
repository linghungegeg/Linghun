...
- **July 12, 2026 (Current Perfect Edition)**: The pre-check engine completed its product-grade convergence. Only the five mature paths—TypeScript/TSX, Python, Rust, Go, and Java—are exposed to the model; all other languages remain hidden until they pass the same acceptance bar. The five paths passed independent 1K, concurrent, mixed-language, restart, and missing-tool gates. See: [Updates](./docs/updates.en.md#july-12-2026-product-grade-pre-check-engine-convergence).
